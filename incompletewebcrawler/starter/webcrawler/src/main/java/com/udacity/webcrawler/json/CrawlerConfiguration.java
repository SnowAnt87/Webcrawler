...
public final class CrawlerConfiguration {
  ...
  public Builder addStartPages(List<String> startPages) {
  ...
  public Builder addIgnoredWords(List<String> ignoredWords) {
      for (String word : ignoredWords) {
          // Convert the word to lowercase before adding
          this.ignoredWords.add(Objects.requireNonNull(word).toLowerCase());
      }
      return this;
  }

    @JsonProperty("ignoredUrls")
    public Builder addIgnoredUrls(List<String> ignoredUrls) {
        for (String url : ignoredUrls) {
            this.ignoredUrls.add(Objects.requireNonNull(url));
        }
        return this;
    }
